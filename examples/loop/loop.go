...
const AlwaysSnapshot = false
const TrapAfterSnapshot = false

// stackWasm was generated by the following:
//	cd testdata; wat2wasm --debug-names add.wat
//go:embed testdata/local.wasm
var stackWasm []byte
...
func main() {
	...
	ctx = context.WithValue(ctx, "always_snapshot", AlwaysSnapshot)
	ctx = context.WithValue(ctx, "trap_after_snapshot", TrapAfterSnapshot)
